  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 px-3 py-4 border-b border-skin-base">
        ...
        {!collapsed && <div className="flex-1 text-center font-extrabold tracking-wide text-lg" />}
      </div>

      {/* Banner (hidden when collapsed) */}
      {!collapsed && (
        <div className="px-3 py-4">
          <img src="/banner.png" alt="Tempest Guild banner" className="rounded-2xl border border-skin-base w-full" />
        </div>
      )}
      ...
      <nav className="px-2 pt-2">
        <ul className="space-y-1">
          ...
          <li aria-hidden="true">
            <hr className={clsx("my-3 border-t-2 border-dashed border-skin-base/50", !collapsed && "mx-3")} />
          </li>
